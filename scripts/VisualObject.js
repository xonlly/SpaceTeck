		...
		this.ctx.save();
			...
			for (var key in player) {
				...
				this.ctx.save();
					...
					this.ctx.strokeText((player[key].mouse.orientation*1+180).toFixed(4)+" deg | vitesse: "+player[key].vitesse.toFixed(4)+" orientation: "+((player[key].orientation+180).toFixed(4))+" deg", 40, -25);
